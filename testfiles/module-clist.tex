...
\ClistNew \lFooSomeList
\ClistSet \lFooSomeList {one,two,three}
\ClistVarLog \lFooSomeList
\ENDTEST
...
\BEGINTEST{Testing \ClistRemoveDuplicates}
\ClistSet \lTmpaClist {one,two,one,two,three}
\ClistRemoveDuplicates \lTmpaClist
\ClistVarJoin \lTmpaClist {,}
\ENDTEST

\BEGINTEST{Testing \ClistRemoveAll}
\ClistSet \lTmpaClist {one,two,one,two,three}
\ClistRemoveAll \lTmpaClist {two}
\ClistVarJoin \lTmpaClist {,}
\ENDTEST

\BEGINTEST{Testing \ClistReverse}
\ClistSet \lTmpaClist {one,two,one,two,three}
\ClistReverse \lTmpaClist
\ClistVarJoin \lTmpaClist {,}
\ENDTEST
...
\IgnoreSpacesOn
\TlSet \lTmpkTl {one,two,three}
\TlClear \lTmpaTl
\ClistVarMapInline \lTmpkTl {
  \TlPutRight \lTmpaTl {(#1)}
}
\Result {\TlUse\lTmpaTl}
\IgnoreSpacesOff
