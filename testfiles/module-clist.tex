...
\ClistIfInTF {one,two} {one} {\Return{Yes}} {\Return{Not}}
\ClistIfInTF {one,two} {three} {\Return{Yes}} {\Return{Not}}
\ENDTEST

\BEGINTEST{Testing \ClistVarIfIn}
\ClistSet \lTmpaClist {one,two}
\ClistVarIfInTF \lTmpaClist {one} {\Return{Yes}} {\Return{Not}}
\ClistVarIfInTF \lTmpaClist {three} {\Return{Yes}} {\Return{Not}}
\ENDTEST
